...
const TeacherSignin = () => {
  ...
  const inputClass = 'w-full h-10 px-3 rounded-lg bg-slate-800 border border-white/[0.08] text-sm text-white placeholder-slate-500 outline-none transition-colors focus:border-violet-500 focus:ring-1 focus:ring-violet-500';
